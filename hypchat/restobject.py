...
_urls_to_objects[re.compile(r'.*/v2/room/[^/]+$')] = Room
...
_urls_to_objects[re.compile(r'.*/v2/user/[^/]+$')] = User
...
_urls_to_objects[re.compile(r'.*/v2/room/[^/]+/member$')] = MemberCollection
...
_urls_to_objects[re.compile(r'.*/v2/user$')] = UserCollection
...
_urls_to_objects[re.compile(r'.*/v2/room$')] = RoomCollection
...
_urls_to_objects[re.compile(r'.*/v2/room/[^/]+/webhook$')] = WebhookCollection

class EmoticonCollection(RestObject, Collection):
	pass

_urls_to_objects[re.compile(r'.*/v2/emoticon$')] = EmoticonCollection
...
_urls_to_objects[re.compile(r'.*/v2/room/[^/]+/webhook/[^/]+$')] = Webhook
...
_urls_to_objects[re.compile(r'.*/v2/room/[^/]+/history$')] = HistoryCollection
